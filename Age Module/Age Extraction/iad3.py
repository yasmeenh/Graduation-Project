# -*- coding: utf-8 -*-
"""
Created on Sat Apr 21 14:56:08 2018
...
def split_into_lemmas(text):
    ...
    return [stemmer.stem(word.lemmatize()) for word in words]

# use split_into_lemmas as the feature extraction function
vect = CountVectorizer(analyzer=split_into_lemmas,ngram_range=(1, 2), min_df=2,stop_words='english')
tokenize_test(vect)
#
## last 50 features
#print vect.get_feature_names()[-50:]
